-- ============================================================================
-- QUALIAPPS - SCHÉMA DE BASE DE DONNÉES
-- ============================================================================
--
-- Version: 2.0 - Authentification personnalisée (sans auth.users)
-- Date: 2024-12-29
--
-- IMPORTANT: Utilise une table `users` personnalisée pour l'authentification
-- PAS de dépendance sur auth.users de Supabase
--
-- Pour exécuter: Copiez-collez dans Supabase SQL Editor
...
-- Politiques permissives (l'app gère la sécurité côté serveur)
